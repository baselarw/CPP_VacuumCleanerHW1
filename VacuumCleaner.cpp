...
/*
 *constructor of VacuumCleaner class
 ...
 */
VacuumCleaner::VacuumCleaner(int start_x, int start_y, double max_battery, int max_steps)
 ...
 */
int VacuumCleaner::getTotalSteps() const
{
    return total_steps;
}
 ...
 */
bool VacuumCleaner::IsOutOfSteps() const
{
 ...
 */
std::vector<std::pair<int, int>> VacuumCleaner::getBack_steps() const
{
    return back_steps;
}
 ...
 */
std::vector<std::pair<int, int>> VacuumCleaner::getAll_steps() const
{
    return all_steps;
}
 ...
 */
void VacuumCleaner::setPostionToDockingStation()
{
 ...
 */
int VacuumCleaner::getMaxSteps() const
{
    return max_steps;
}
 ...
 */
double VacuumCleaner::getMaxBattery() const
{
    return max_battery;
}
 ...
 */
int VacuumCleaner::getBack_stepsSize() const
{
    int cnt = 0;
 ...
 */
int VacuumCleaner::getAll_stepsSize() const
{
    int cnt = 0;
